...
public class HICTEVACIOOLDItem extends Item {
	public HICTEVACIOOLDItem() {
		super(new Item.Properties().tab(HicteModTabs.TAB_MO_DOLD).stacksTo(24).rarity(Rarity.COMMON));
	}
